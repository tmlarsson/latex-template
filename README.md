A copy of the template created by @kwlg with some more macros added for mathematics, thus all credit lies with him. Also the repository which `mktex` points to.
